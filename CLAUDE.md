...
The server exposes 146 tools but **does NOT register them all directly with MCP**. Instead:
...
- **Routed tools** (137): Discoverable via 4 meta-tools: `list_tool_categories`, `get_category_tools`, `execute_tool`, `search_tools`
